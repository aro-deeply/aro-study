/* 화면 예시용 가명 데이터. 실제 멤버·금액이 아니다. demo/index.html 과 index.html?demo=1 이 사용한다.
   운영 방식: 1기 회비 1인 50,000원. 모임 비용은 회비에서(source: "fund"), 회비 밖 추가 비용만 참석자 n분의 1(source: "split"). */
...
export const DUES = [
  ...
  { id: "d2", termId: "t1", memberId: "b", amount: 50000, date: "2026-09-12" },
  { id: "d3", termId: "t1", memberId: "c", amount: 50000, date: "2026-09-15" },
  { id: "d4", termId: "t1", memberId: "e", amount: 50000, date: "2026-09-15" },
  // 멤버D는 미납
];
...
export const EXPENSES = [
  { id: "e1", sessionId: "2026-09-15", date: "2026-09-15", item: "저녁 식사", amount: 96500, category: "식사", source: "fund", paidBy: "a", splitAmong: "attendees" },
  { id: "e2", sessionId: "2026-09-15", date: "2026-09-15", item: "카페", amount: 32000, category: "카페", source: "fund", paidBy: "b", splitAmong: "attendees", note: "멤버B가 대신 결제" },
  { id: "e3", sessionId: "2026-09-15", date: "2026-09-15", item: "스터디룸 2시간", amount: 24000, category: "장소", source: "fund", paidBy: "a", splitAmong: "attendees" },
  { id: "e4", sessionId: "2026-09-15", date: "2026-09-14", item: "자료 인쇄", amount: 13700, category: "기타", source: "split", paidBy: "a", splitAmong: "attendees", note: "회비 밖 추가 비용" },
  { id: "e5", sessionId: "2026-09-29", date: "2026-09-29", item: "저녁 식사", amount: 42000, category: "식사", source: "fund", paidBy: "a", splitAmong: "attendees" },
];
export const PAYMENTS = [
  { id: "p1", sessionId: "2026-09-15", from: "fund", to: "b", amount: 32000, date: "2026-09-16", note: "카페 대신 결제분 보전" },
  { id: "p2", sessionId: "2026-09-15", from: "d", to: "a", amount: 2700, date: "2026-09-16" },
];
